...
import 'store_copy_copy_model.dart';
export 'store_copy_copy_model.dart';

class StoreCopyCopyWidget extends StatefulWidget {
  const StoreCopyCopyWidget({Key? key}) : super(key: key);

  @override
  _StoreCopyCopyWidgetState createState() => _StoreCopyCopyWidgetState();
}

class _StoreCopyCopyWidgetState extends State<StoreCopyCopyWidget> {
  late StoreCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StoreCopyCopyModel());
  }
